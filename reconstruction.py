...
if __name__ == "__main__":
    ...
    training_parser.add_argument('--dataset_dir_name', default='', help='name of the dir containing the dataset if dataset == custom')
        ...
        for i, (data, _) in enumerate(test_loader):
            ...
            if args.save_image:
                for idx in range(data.shape[0]):
                    ...
                    save_image(tensor2im(outputs[0][idx]), save_path + '/rec/' + str(i*args.batch_size+idx)+'.png')
    ...
    # python3 reconstruction.py --model=vqvae --k=5 --data-dir=~/.datasets --hidden=2 --dataset=mnist --c=1.0 --save_image=False
    # python3 reconstruction.py --model=vqvae --k=128 --data-dir=~/.datasets --dataset=cifar10 --c=1.0 --save_image=False --model-path=/results/2022-10-08_21-23-46_hyperbolic_data_cifar10_k_128_c_1.0_hidden_None  --specific-epoch-model-file=/checkpoints/model_50.pth
    # python3 reconstruction.py --model=vqvae --k=10 --hidden=10 --data-dir=~/.datasets --dataset=mnist --c=1.0 --save_image=True --model-path=/results/2022-10-28_17-16-31_hyperbolic_data_mnist_k_10_c_1.0_hidden_10 --specific-epoch-model-file=/checkpoints/model_6.pth
